...
switch ($method) {
    case 'GET':
        if ($endpoint === 'producto') {
            ...
            $sql = "SELECT idproducto,idcategoria,idsubcategoria,idproveedor, descripcion,precioventa,preciocosto,deposito,ubicacion,stockmin,stock,stockmax,descripcioncompleta,codigoArticulo, estado, imagen
                    FROM productos_web 
    ...
    case 'POST':
        if ($endpoint === 'producto') {
            ...
            $sql = "INSERT INTO productos_web (idcategoria,idsubcategoria,idproveedor,descripcion,,precioventa,preciocosto,deposito,ubicacion,stockmin,stock,stockmax,descripcioncompleta,codigoArticulo, estado, imagen)
                    VALUES (:idcategoria,:idsubcategoria,:idproveedor,:descripcion,:precioventa,:preciocosto,:deposito,:ubicacion,:stockmin,:stock,:stockmax,:descripcioncompleta,:codigoArticulo, :estado, :imagen)";
            $stmt = $pdo->prepare($sql);
            $stmt->execute($data);
